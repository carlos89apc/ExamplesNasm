...
section .data
	...
	path1 db "/home/carlos/GitNasmExamples/ExamplesNasm/Nuevo/operando3.txt", 0
	path2 db "/home/carlos/GitNasmExamples/ExamplesNasm/Nuevo/operando4.txt", 0
	path3 db "/home/carlos/GitNasmExamples/ExamplesNasm/Nuevo/resultados.txt", 0
